...
//	protected final ProgressBar mHeaderProgress;
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		default:
			LayoutInflater.from(context).inflate(
					R.layout.pull_to_refresh_header_simple, this);
			break;
		}

		mInnerLayout = (FrameLayout) findViewById(R.id.fl_inner1);
		mHeaderText = (TextView) mInnerLayout
				.findViewById(R.id.pull_to_refresh_text1);
//		mHeaderProgress = (ProgressBar) mInnerLayout
//				.findViewById(R.id.pull_to_refresh_progress);
		mSubHeaderText = (TextView) mInnerLayout
				.findViewById(R.id.pull_to_refresh_sub_text1);
		mHeaderImage = (ImageView) mInnerLayout
				.findViewById(R.id.pull_to_refresh_image1);
