...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	// private OnScrollListener1 onScrollListener1;
	// /**
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		// onScrollListener1.onScroll(lastScrollY = this.getScrollY());
		// }
	...
	public static enum AnimationStyle {
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode,
			...
			case ROTATE:
			default:
				return new TweenAnimLoadingLayout(context, mode, scrollDirection,
						attrs);
			case FLIP:
				return new TweenAnimLoadingLayout(context, mode, scrollDirection,
						attrs);
	...
	// */
	// public void setOnScrollListener1(OnScrollListener1 onScrollListener1){
	...
	// }
	// if(onScrollListener1 != null){
	// onScrollListener1.onScroll(scrollY);
	// }
	//
	// };
	//
