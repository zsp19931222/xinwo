...
public class Crowdfunding_Product_DetailsActivity extends SwipeBackActivity implements OnClickListener{
	...
	private LinearLayout home_page_product_details_moreRel;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.home_page_product_details);
		FinishActivity.finish(R.id.hp_dp_returnRel, Crowdfunding_Product_DetailsActivity.this);
		findID();
		isListView();
	...
	private void findID() {
		...
		int width = wm.getDefaultDisplay().getWidth();
	     ...
	     home_page_product_details_moreRel=(LinearLayout) findViewById(R.id.home_page_product_details_moreRel);
	     home_page_product_details_moreRel.setOnClickListener(this);
	}
	private void isListView() {
		...
		list.add(new Home_Page_Product_DetailsBean("http://g.hiphotos.baidu.com/imgad/pic/item/f603918fa0ec08faffbf5de25eee3d6d55fbda3c.jpg", "用户名", "2", "时间"));
		list.add(new Home_Page_Product_DetailsBean("http://g.hiphotos.baidu.com/imgad/pic/item/f603918fa0ec08faffbf5de25eee3d6d55fbda3c.jpg", "用户名", "2", "时间"));
	adapter=new Home_Page_Product_DetailsAdapter(list, Crowdfunding_Product_DetailsActivity.this);
		...
		hp_pd_viewpager.setAdapter(new PagerAdapter() {
			...
			public Object instantiateItem(ViewGroup container, int position) {
				...
				ImageloaderUtils.MyImageLoader2(url.get(position), bg,
						Crowdfunding_Product_DetailsActivity.this);
	...
	public void onClick(View v) {
		if (Tool.isFastDoubleClick()) {
			...
			switch (v.getId()) {
			case R.id.home_page_product_details_moreRel:
				Product_Detail_Pop pop=new Product_Detail_Pop(Crowdfunding_Product_DetailsActivity.this);
				pop.showPopupWindow(home_page_product_details_moreRel);
				break;
