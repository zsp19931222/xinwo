package com.quwu.xinwo.cropimage;
...
import com.quwu.xinwo.until.BitmapUtils;
import com.quwu.xinwo.until.FileUtils;
...
public class CropHelper {
	...
	public void startCamera() {
		...
		System.out.println(Uri.fromFile(temp));
	...
	public void getDataFromCamera(Intent data) {
		File temp = new File(mTempPhotoPath);
		Log.e("3=",mTempPhotoPath);
		if (!temp.exists()) {
			showToast(HEAD_SET_CANCEL);
		} else {
			Uri uri = null;
			try {
				Log.e("进入剪切=",mTempPhotoPath);
