...
import com.quwu.xinwo.sqlite.MyLetterListView;
import com.quwu.xinwo.sqlite.MyLetterListView.OnTouchingLetterChangedListener;
...
public class AreaActivity extends SwipeBackActivity implements OnScrollListener {
	...
	private TextView locateHint;// 定位显示
	private TextView city;// 定位显示
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		FinishActivity.finish(R.id.activity01_returnRel, AreaActivity.this);
		...
		personList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position >= 4) {
					...
					Intent intent=new Intent(AreaActivity.this,City_WideActivity.class);
					intent.putExtra("area_name", allCity_lists.get(position).getName());
					setResult(0, intent);
					finish();
				}
			}
		...
		resultList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Toast.makeText(getApplicationContext(),
						...
						.show();
				Intent intent=new Intent(AreaActivity.this,City_WideActivity.class);
				intent.putExtra("area_name", city_result.get(position).getName());
				setResult(0, intent);
				finish();
			}
		});
	...
	private void cityInit() {
		City city = new City("定位", "0","0"); // 当前定位城市
		allCity_lists.add(city);
		city = new City("最近", "1","0"); // 最近访问的城市
		allCity_lists.add(city);
		city = new City("热门", "2","0"); // 热门城市
		allCity_lists.add(city);
		city = new City("全部", "3","0"); // 全部城市
		allCity_lists.add(city);
	...
	public void hotCityInit() {
		City city = new City("上海", "2","0");
		city_hot.add(city);
		city = new City("北京", "2","0");
		city_hot.add(city);
		city = new City("广州", "2","0");
		city_hot.add(city);
		city = new City("深圳", "2","0");
		city_hot.add(city);
		city = new City("武汉", "2","0");
		city_hot.add(city);
		city = new City("天津", "2","0");
		city_hot.add(city);
		city = new City("西安", "2","0");
		city_hot.add(city);
		city = new City("南京", "2","0");
		city_hot.add(city);
		city = new City("杭州", "2","0");
		city_hot.add(city);
		city = new City("成都", "2","0");
		city_hot.add(city);
		city = new City("重庆", "2","0");
		city_hot.add(city);
	}
	...
	public class ListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (viewType == 0) { // 定位
				...
				locateHint = (TextView) convertView
					...
					public void onClick(View v) {
						if (locateProcess == 2) {
							Toast.makeText(getApplicationContext(),
									...
									Toast.LENGTH_SHORT).show();
							Intent intent=new Intent(AreaActivity.this,City_WideActivity.class);
							intent.putExtra("area_name", city.getText().toString());
							setResult(0, intent);
							finish();
				...
				rencentCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Toast.makeText(getApplicationContext(),
								...
								.show();
						Intent intent=new Intent(AreaActivity.this,City_WideActivity.class);
						intent.putExtra("area_name", city_history.get(position));
						setResult(0, intent);
						finish();
					}
				});
				...
				hotCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Toast.makeText(getApplicationContext(),
								...
								Toast.LENGTH_SHORT).show();
						Intent intent=new Intent(AreaActivity.this,City_WideActivity.class);
						intent.putExtra("area_name", city_hot.get(position).getName());
						setResult(0, intent);
						finish();
					}
				});
	...
	protected void onStart() {
		...
		if (city != null) {
			city.setOnClickListener(new OnClickListener() {
				...
				@Override
				public void onClick(View v) {
					if (city.getText().toString().equals("重新选择")) {
						locationService.start();// 定位SDK
	...
	public void logMsg(String str) {
		try {
			...
			if (str != null) {
				city.setText(str);
				locateHint.setText("当前城市");
			
				locationService.stop(); //停止定位服务
			} else {
				city.setText("重新选择");
				locateHint.setText("定位城市失败");
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
