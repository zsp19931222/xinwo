...
public class City_Wide_All_pop extends PopupWindow implements OnScrollListener {
	...
	public City_Wide_All_pop(Activity activity,final PullableScrollView scrollView,final int scrollY) {
...
//			}
			city = new City("重庆", "chongqing", "1");
			city = new City("北京", "beijing", "2");
			city = new City("上海", "shanghai", "3");
			city = new City("天津", "tianjing", "4");
			city_result.add(city);
			cursor.close();
			db.close();
		} catch (IOException e) {
