...
public class RentAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.rent_item, null);
			holder.gridView = (MyGridView) convertView
					.findViewById(R.id.rent_item_gridview);
			holder.goodsNameText = (TextView) convertView
					.findViewById(R.id.rent_item_goods_nameText);
			holder.goodsDescribeText = (TextView) convertView
					.findViewById(R.id.rent_item_goods_describeText);
			holder.area_timeText = (TextView) convertView
					.findViewById(R.id.rent_item_area_timeText);
			holder.priceText = (TextView) convertView
					.findViewById(R.id.rent_item_priceText2);
			holder.residueText = (TextView) convertView
					.findViewById(R.id.rent_item_residueText2);
			holder.button = (Button) convertView
					.findViewById(R.id.rent_item_btn);
		...
		holder.priceText.setText(list.get(position).getRentprice());
		holder.residueText.setText(list.get(position).getRent_period());
